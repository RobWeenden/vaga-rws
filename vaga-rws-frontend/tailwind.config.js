  ...
  theme: {
    extend: {
      height: {
        ...
        "content-area": "calc(100vh - 80px)", // Ajuste baseado na altura do seu header
      },
      minHeight: {
        screen: "100vh",
        "screen-safe": "calc(100vh - 80px)", // Para garantir espaço para o header
        dynamic: "auto",
        content: "calc(100vh - 80px)",
      },
      maxHeight: {
        "screen-dynamic": "calc(100vh - 80px)",
      },
      fontFamily: {
  ...
  plugins: [
    function({ addUtilities }) {
      const newUtilities = {
        ...
        '.h-viewport-adjust': {
          height: 'auto',
          minHeight: 'calc(100vh - 80px)', // Ajuste conforme necessário
        },
        '.main-content': {
          flex: '1 1 auto',
          overflowY: 'auto',
